...
import (
	...
	apaarshrmdevv1alpha1 "github.com/apaarshrm39/Kluster/pkg/apis/apaarshrm.dev/v1alpha1"
	versioned "github.com/apaarshrm39/Kluster/pkg/client/clientset/versioned"
	internalinterfaces "github.com/apaarshrm39/Kluster/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/apaarshrm39/Kluster/pkg/client/listers/apaarshrm.dev/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApaarshrmV1alpha1().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApaarshrmV1alpha1().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&apaarshrmdevv1alpha1.Kluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apaarshrmdevv1alpha1.Kluster{}, f.defaultInformer)
}
