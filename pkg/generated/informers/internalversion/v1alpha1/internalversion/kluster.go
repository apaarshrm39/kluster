...
import (
	...
	internalinterfaces "github.com/apaarshrm39/Kluster/pkg/generated/informers/internalversion/internalinterfaces"
	internalversion "github.com/apaarshrm39/Kluster/pkg/generated/listers/v1alpha1/internalversion"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Apaarshrm().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Apaarshrm().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&v1alpha1.Kluster{},
		resyncPeriod,
